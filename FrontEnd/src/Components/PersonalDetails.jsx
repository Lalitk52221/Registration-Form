...
const PersonalDetails = () => {
 ...
 const handleFileChange = (e)=>{
    ...
    reader.onloadend=()=>{
      setPhoto(reader.result) // convert image to Base64
    };
    if(file){
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try{
      await axios.post(POST_Data_URL,{name, email, phone, altPhone, father, fatherOccupation, mother, motherOccupation, address, gender, dob,state, aadharNumber, education, photo})
